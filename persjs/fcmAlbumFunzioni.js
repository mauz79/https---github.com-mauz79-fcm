...
document.write("<form name='frmFsq' id='frmFsq' action='album.htm' method='get'>")
	...
	for(i=0;i<album.length-1;i++) {
		...
		document.write ("  <tr class='onOut' onMouseOver=\"this.className='onOver'\" onMouseOut=\"this.className='onOut'\">")
		    ...
		    document.write ("    <td align='center'>" + album[i].NomeDivisione + "</td>");
              ...
              document.write ("    <td><a href='../"+arrDirectory[CercaCartellaStagione(album[i].Stagione)].Directory+"/rose.htm?Fsq=" + album[i].IDSquadra + "'>" + album[i].NomeSquadra + "</a></td>");
