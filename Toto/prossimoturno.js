...
/* if (NumIncVisProTur > 0) {
	document.write(" <tr class='newscell3'><TD colspan=13 class='toto'><strong> ")
...
if (NumIncVisProTur > 0) {
document.write(" <tr><TD class='rigaTiT'><strong>")
document.write(" <scr" + "ipt type='text/javascript'> ")
document.write(" document.write (RiempiListaIncontri(GetProssimaGiornataDaGiocare(),0)[1].Competizione) </scr" + "ipt></strong> ")
document.write(" <br><span class='rigaDaT'><scr" + "ipt type='text/javascript'> ")
document.write(" document.write (dataGiornata[RiempiListaIncontri(GetProssimaGiornataDaGiocare(),0)[1].GiornataDiA])</scr" + "ipt><br><br></span></td></tr> ")
}
