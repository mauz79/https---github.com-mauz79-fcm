...
var d10	
	...
	for (i=1;i<arr.length;i++) {
		...
		if (iCorrGiornataDiA != iPrecGiornataDiA) {
			...
			cale.SetValore(iCorrRiga,iCorrCol,"Giornata di A: " + iCorrGiornataDiA + "<span class='dataCaL'>&nbsp;&nbsp;("+dataGiornata[iCorrGiornataDiA]+")</span> &nbsp;<a class='white2'  href='form.htm?cGio=" + iCorrGiornataDiA + "'>Formazioni</a>&nbsp;" + "|&nbsp;<a class='white' href='ris.htm?cGio=" + iCorrGiornataDiA + "'>Tabellini</a>")
