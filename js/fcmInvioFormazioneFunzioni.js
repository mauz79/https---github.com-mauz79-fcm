...
function GeneraTabellaGiocatori()
{
	...
	tabR.SetValore(1, 9, "PrF");
	
	var c;
	for (c = 1; c <= 9; tabR.SetStile(1, c++, "IntRossoBlu"));
	...
	for (g = 0; g < arrInvioFormazione.length; g++) {
		...
		// probabile formazione puffin
		tabR.SetValore(cnt, 9, "<span class='t-xxs'>" + PerCento(gg.NomeCode) + "</span>");
		//tabR.SetValore(cnt, 9, "<span > ---</span>"); //riga inserita
		tabR.SetStile(cnt, 9, "Form" + pd + "Centro");
...
tabR.Stampa();
	...
	// Stampa tabella
	tabF.Stampa();
//stampa tabella probabili formazioni
	document.write("<br>")
	document.write("<tr>")
document.write("<table align='center' height='40' cellpadding='0' cellspacing='0' width='160'><tr>")
    document.write("<td><a href='probform/Atalanta.php' target='probform'><img alt='Atalanta'src='img/sq/logo/Atalanta.gif' height='30' border='/'></a></td>")
document.write("<td><a href='probform/Bologna.php' target='probform'><img alt='Bologna'src='img/sq/logo/Bologna.gif' height='30' border='/'></a></td>")
document.write("<td><a href='probform/Cagliari.php' target='probform'><img alt='Cagliari'src='img/sq/logo/Cagliari.gif' height='30' border='/'></a></td>")
document.write("<td><a href='probform/Catania.php' target='probform'><img alt='Catania'src='img/sq/logo/Catania.gif' height='30' border='/'></a></td>")
document.write("<td><a href='probform/Cesena.php' target='probform'><img alt='Cesena'src='img/sq/logo/Cesena.gif' height='30' border='/'></a></td>")
document.write("<td><a href='probform/Chievo.php' target='probform'><img alt='Chievo'src='img/sq/logo/Chievo.gif' height='30' border='/'></a></td>")
document.write("<td><a href='probform/Fiorentina.php' target='probform'><img alt='Fiorentina'src='img/sq/logo/Fiorentina.gif' height='30' border='/'></a></td>")
document.write("<td><a href='probform/Genoa.php' target='probform'><img alt='Genoa'src='img/sq/logo/Genoa.gif' height='30' border='/'></a></td>")
document.write("<td><a href='probform/Inter.php' target='probform'><img alt='Inter'src='img/sq/logo/Inter.gif' height='30' border='/'></a></td>")
document.write("<td><a href='probform/Juventus.php' target='probform'><img alt='Juventus'src='img/sq/logo/Juventus.gif' height='30' border='/'></a></td>")
document.write("<td><a href='probform/Lazio.php' target='probform'><img alt='Lazio'src='img/sq/logo/Lazio.gif' height='30' border='/'></a></td>")
document.write("<td><a href='probform/Lecce.php' target='probform'><img alt='Lecce'src='img/sq/logo/Lecce.gif' height='30' border='/'></a></td>")
document.write("<td><a href='probform/Milan.php' target='probform'><img alt='Milan'src='img/sq/logo/Milan.gif' height='30' border='/'></a></td>")
document.write("<td><a href='probform/Napoli.php' target='probform'><img alt='Napoli'src='img/sq/logo/Napoli.gif' height='30' border='/'></a></td>")
document.write("<td><a href='probform/Novara.php' target='probform'><img alt='Novara'src='img/sq/logo/Novara.gif' height='30' border='/'></a></td>")
document.write("<td><a href='probform/Palermo.php' target='probform'><img alt='Palermo'src='img/sq/logo/Palermo.gif' height='30' border='/'></a></td>")
document.write("<td><a href='probform/Parma.php' target='probform'><img alt='Parma'src='img/sq/logo/Parma.gif' height='30' border='/'></a></td>")
document.write("<td><a href='probform/Roma.php' target='probform'><img alt='Roma'src='img/sq/logo/Roma.gif' height='30' border='/'></a></td>")
document.write("<td><a href='probform/Siena.php' target='probform'><img alt='Siena'src='img/sq/logo/Siena.gif' height='30' border='/'></a></td>")
document.write("<td><a href='probform/Udinese.php' target='probform'><img alt='Udinese'src='img/sq/logo/Udinese.gif' height='30' border='/'></a></td>")
document.write("</tr></table>")
document.write("<iframe align='top' frameborder='0' scrolling='no' allowtransparency='yes' name='probform' height='245' width='600' src='probform/Inter.php'> </iframe>")
	document.write("</tr>")
