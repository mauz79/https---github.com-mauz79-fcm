...
for (i=1;i<tableIncrociTeams.length;i++){
	document.write("<td class='t-xxsNero'>"+tableIncrociTeams[i].substring(0,25)+"</td>")
}
document.write("</tr><tr class='rigasquadre'></tr><tr class='rigasquadre'></tr>")
for (i=1;i<tableIncrociTeams.length;i++){	
	document.write("<tr class='rigaincrocipari'>")
	
	document.write("<td class='cellasquadra'>"+tableIncrociTeams[i].substring(0,25)+"</td>")
	for (j=1;j<tableIncrociTeams.length;j++){
	...
	document.write("<tr><td colspan='6'class='immaginestat'></td><td colspan='"+(tableIncrociTeams.length/2+1)+"'></td></tr>")		
