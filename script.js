...
function NewsFCM() {
	//document.write("<p class='bold'>"+News1+"</p><p class='mar2'>"+News2+"</p>")
	//document.write("<p class='bold'>"+News3+"</p><p class='mar2'>"+News4+"</p>")
	//document.write("<p class='bold'>"+News5+"</p><p class='mar2'>"+News6+"</p>")
	document.write("<strong>"+News1+"</strong><br>"+News2+"<br>")
	document.write(News3+"<br><b>"+News4+"</b><br>")
	document.write(News5)
	// document.write("<p class='newscel3'>"+News5+"</p><p class='newscel3'>"+News6+"</p>")
}
